    ...
    <div className="w-full bg-[#f7faf7]">
      ...
      <section className="max-w-5xl mx-auto px-6 py-12 text-center">
        ...
        <p className="text-gray-700 text-lg">
          Get in touch for consultations, training sessions, or general enquiries.
        </p>
      </section>
      ...
      <section className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 px-6 pb-16">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white shadow rounded-2xl p-6">
            ...
            <p className="text-gray-700 mb-3">
              ...
              In Front of Indian Chilly, Vidya’s Protein World, <br />
              Shankar Nagar, Raipur, Chhattisgarh
            </p>

            <p className="text-gray-700 mb-3">
              📞 <strong>Phone / WhatsApp:</strong><br />
              8982627838, 9589345938
            </p>

            <p className="text-gray-700 mb-3">
              ✉️ <strong>Email:</strong><br />
              info@drmeetamishra.com
            </p>
          </div>
        </div>
        ...
        <div className="bg-white shadow rounded-2xl p-8">
          ...
          <form className="space-y-5">
            ...
            <select className="w-full border border-green-300 rounded-xl p-3 focus:ring-2 focus:ring-green-500 outline-none">
            ...
            <button className="w-full bg-green-600 text-white py-3 rounded-xl text-lg font-semibold shadow hover:bg-green-700 transition">
              Submit
            </button>
