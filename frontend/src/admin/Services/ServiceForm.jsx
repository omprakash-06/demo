...
export default function ServiceForm({ refresh, selected, setSelected }) {
  ...
  useEffect(() => {
    if (selected) {
      ...
      setFile(null); // user can upload new image
    }
  }, [selected]);
  ...
  return (
    <div className="bg-white p-4 rounded-xl shadow border space-y-4 mb-6">
      ...
      <label className="border-2 border-dashed border-green-400 rounded-lg w-full h-48 flex flex-col items-center justify-center cursor-pointer hover:bg-green-50">
        {file ? (
